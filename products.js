const products = [
...

    {
        ...
        seo: {
            ...
            keywords: 'MagSafe case, iPhone MagSafe case Bangladesh, premium phone case, MagSafe cover'
...
const testimonials = [

    {
        ...
        rating: 5,
        text: 'অসাধারণ সার্ভিস! ফোনটা একদম অরিজিনাল প্যাকেজিং এ পেয়েছি এবং ডেলিভারিও খুব দ্রুত হয়েছে। CTG Mobile Tech থেকে কিনে খুব খুশি।'
    },
    {
        id: 2,
        name: 'Farzana Akter',
        ...
        rating: 5,
        text: 'দাম অনুযায়ী সেরা প্রোডাক্ট। কাস্টমার সাপোর্ট টিম খুব হেল্পফুল ছিল, সব প্রশ্নের উত্তর দিয়েছে ধৈর্য নিয়ে। আবার কিনবো ইনশাআল্লাহ।'
    },
    {
        id: 3,
        name: 'Tanvir Ahmed',
        ...
        rating: 4,
        text: 'ভালো মানের ফোন, রিজনেবল প্রাইসে পেয়েছি। ডেলিভারি সময়মতো হয়েছে। রিকমেন্ড করবো সবাইকে।'
    },
    {
        id: 4,
        name: 'Happy Customer',
        img: 'https://i.ibb.co/WWN7Mxgc/101.jpg',
        rating: 5,
        text: 'আরেকজন সন্তুষ্ট কাস্টমারের হাতে তার কাঙ্ক্ষিত ফোনটি তুলে দেওয়া হলো। আপনাদের বিশ্বাসই আমাদের সবচেয়ে বড় প্রাপ্তি।'
    }
